...
namespace EventPlus_.Controller
{
    ...
    {
        private readonly PresencasRepository _presencaRepository;

        public PresencaController(PresencasRepository presencaRepository)
        {
        ...
        public IActionResult Get()
        {
            try
            {
                List<PresencaEvento> listaPresencas = _presencaRepository.Listar();
        ...
        public IActionResult Get(Guid id)
        {
            try
            {
                List<PresencaEvento> listaMinhasPresencas = _presencaRepository.ListarMinhasPresencas(id);
